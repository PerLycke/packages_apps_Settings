...
public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    private static final String KEY_SPRING_VERSION = "spring_version";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setValueSummary(KEY_SPRING_VERSION, "ro.spring.version");
        findPreference(KEY_SPRING_VERSION).setEnabled(true);
